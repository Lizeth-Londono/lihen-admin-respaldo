...
export async function createQuickSaleAtomic(payload) {
  return unwrap(await supabase.rpc('create_quick_sale_financial_atomic_idempotent', ensureOperationKey(payload, 'crear_venta_rapida')), 'No fue posible registrar la venta rápida.');
}
