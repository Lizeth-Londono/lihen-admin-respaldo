import { normalizePhone as normalizeBusinessPhone, createWhatsAppUrl } from './services/whatsapp-service.js';
...
export const colombiaPhone = value => normalizeBusinessPhone(value);
export const whatsappUrl = (phone, message) => createWhatsAppUrl(phone, message);
